...
var displayMap = function displayMap(locations) {
  ...
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/mapbox/streets-v11' // center: [-103.348288, 20.662867],
    // zoom: 10
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Marker({
      element: el,
      anchor: 'bottom'
    }).setLngLat(loc.coordinates).addTo(map); // entend map bound to include current location
...
var stripe = Stripe('pk_test_rOu3BGxhuloo11LgfoJxYQ7p00I1PVEXhw');
...
var logOutBtn = document.querySelector('.nam__el--logout');
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "37447" + '/');
